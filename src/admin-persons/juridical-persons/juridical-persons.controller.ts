...
export class JuridicalPersonsController {
  constructor(private readonly juridicalPersonsService: JuridicalPersonsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateJuridicalPersonDto: UpdateJuridicalPersonDto) {
